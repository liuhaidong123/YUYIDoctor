...
package com.doctor.yuyi.wheelView;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.color_white;/*R.drawable.t_user_center_bottom*/;
	private int wheelForeground = R.color.color_white;/*R.drawable.t_user_center_bottom;*/
